...
@section('container')
                                            ...
                                            <div class="keterangan-loket-antrianku">
                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        ...
                                                        id="tombol-hapus-antrean-{{ $i }}" data-id-antrean="{{ $item->id }}"><i class="bi bi-trash-fill"
                                                            "></i> Hapus
                                                        Antrean</button>
                                                        @php
                                                            $i = $i + 1;
    ...
    <div class="modal fade" id="deleteAntreanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('hapus-antrean') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control" id="id_antrean_hapus" name="id_antrean_hapus" readonly hidden>
                    </div>
